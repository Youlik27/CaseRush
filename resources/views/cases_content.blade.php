            ...
            <div class="row">
                ...
                @foreach($cases as $case)
                    @if($case->sections_id_sections == $sect->id_sections)
                        <div class="col-md-3">
                            <div class="card case-card position-relative" onclick="window.location='{{ route('case.show', $case->id_case) }}'" style="cursor: pointer;">

                                <img src="{{ asset('storage/images/cases/' . $case->image_url) }}" alt="Case Image" class="card-img-top">
